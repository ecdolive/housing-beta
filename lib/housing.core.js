...
api_call = function(){
  debug.log('\tapi_call()');
  values = api.calculate(month,year,price,upfront,closing,down,term,interest,pmi,hoa,extra,hoi,flood,tax,appreciation,rent);
};
...
inputs_fill = function(){
  debug.log('inputs_fill()');
  // TODO: clean up location vars, put loc into loc_data object
