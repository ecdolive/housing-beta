...
BUG: input_edit() not detecting changes in input value as intended (can't reproduce)
*/
...
input_edit = debounce(function(x){
  ...
  var value = $(x).val();
  if(value != values[name].display){ // if value changed, update cookie and recalculate // BUG: .display needs to update if this changes
