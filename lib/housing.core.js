...
location_select = function(x){
  if($(x).data()){
    ...
    if(locs[y]){
      ...
      e.e14 = parseFloat(locs[y].mill_county); $('#e14').val(e.e14);
      e.e15 = parseFloat(locs[y].mill_city); $('#e15').val(e.e15);
      e.e18 = parseFloat(locs[y].assessment_ratio); $('#e18').val(e.e18);
      calculate();
