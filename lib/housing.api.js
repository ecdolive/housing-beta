...
Api.prototype.calculate = function(month,year,price,upfront,closing,down,term,interest,pmi,hoa,extra,hoi,flood,tax,appreciation,rent){
  ...
  c._output.total_monthly_payments = Math.round(parseFloat(c._output.monthly_mortgage_payment) + parseFloat(c._output.monthly_tax_insurance_dues)); // Total monthly payments
