api_calculate = function(month,year,price,upfront,closing,down,term,interest,pmi,hoa,extra,hoi,flood,tax,appreciation,rent){
  // console.log('api_calculate(month='+month+',year='+year+',price='+price+',upfront='+upfront+',closing='+closing+',down='+down+',term='+term+',interest='+interest+',pmi='+pmi+',hoa='+hoa+',extra='+extra+',hoi='+hoi+',flood='+flood+',tax='+tax+',appreciation='+appreciation+',rent='+rent+')');
  ...
  make_percent = function(a,b){
    // return ((a / b) * 100).toFixed(1) + '%';
    return ((a / b) * 100).toFixed(1).replace('.0','') + '%';
  };
  make_variants = function(target,display){
