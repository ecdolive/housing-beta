/*
TODO:
- need to set cookie on manual input edit
- need reset to default option for editable inputs and selects
- what all should really change when location is selected?
*/
calc_flood = function(){
