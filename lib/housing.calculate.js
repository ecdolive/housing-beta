...
defaults = function(){
  ...
  // all others
    ...
    e.e13 = 0; // Extra monthly payment
      if(loc.mill_county) e.e14 = loc.mill_county;
      else e.e14 = 8.3 // County millage rate
      if(loc.mill_city) e.e15 = loc.mill_city;
      else e.e15 = 23.2 // City millage rate
      if(loc.assessment_ratio) e.e18 = loc.assessment_ratio;
      else e.e18 = 40 // Assessment ratio
